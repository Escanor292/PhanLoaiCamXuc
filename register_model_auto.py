...
def main():
    ...
    # Use validation metrics as approximation
    # (These are from Epoch 1 validation)
    test_loss = 0.4353
    macro_f1 = 0.0475
    micro_f1 = 0.3333
    hamming_loss = 0.1533
    ...
    print()
    print("📝 Registering model with validation metrics:")
    ...
    try:
        ...
        model_id = registry.register_model(
            ...
            metadata={
                'person': person,
                'experiment_name': f'Khanh Training - 500 samples - {datetime.now().strftime("%Y-%m-%d %H:%M")}',
        ...
        if model_id:
            ...
            print("   Current best model has better metrics")
            print()
            print("Your model:")
            print(f"   • Test Loss: {test_loss:.4f}")
            print(f"   • Macro F1: {macro_f1:.4f}")
            print()
            print("This is normal! The model still learned from your 500 samples.")
